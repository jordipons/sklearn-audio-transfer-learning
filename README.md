...
When using the `openl3` feature extractor you will find that to solve your RAM issues you will have to **increase** the batch size. We recommend to set it to 256. This is possibly due to a bug in the original Openl3 implementation.
